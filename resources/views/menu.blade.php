...
<div class="row tm-welcome-content">
    <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="{{asset('template')}}/img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Our Menus&nbsp;&nbsp;<img src="{{asset('template')}}/img/header-line.png" alt="Line" class="tm-header-line"></h2>
  ...
  <section class="tm-section row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-4 tm-welcome-img-container">
      <div class="inline-block shadow-img">
        <img src="{{asset('template')}}/img/1.jpg" alt="Image" class="img-circle img-thumbnail">  
      </div>              
    </div>            
  </section>          
  <section class="tm-section row">
    <div class="col-lg-12 tm-section-header-container margin-bottom-30">
      <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="{{asset('template')}}/img/logo.png" alt="Logo" class="tm-site-logo"> Our Menus</h2>
    ...
    <div>
      ...
      <div class="tm-menu-product-content col-lg-9 col-md-9"> <!-- menu content -->
        ...
        <div class="tm-product">
          <img src="{{asset('template')}}/img/menu-3.jpg" alt="Product">
          <div class="tm-product-text">
        ...
        <div class="tm-product">
          <img src="{{asset('template')}}/img/menu-4.jpg" alt="Product">
          <div class="tm-product-text">
        ...
        <div class="tm-product">
          <img src="{{asset('template')}}/img/menu-5.jpg" alt="Product">
          <div class="tm-product-text">
